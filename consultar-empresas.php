...
<table class="table table-striped"  border="1">
	<thead class="thead-dark">
		<tr >
			...
			<th class = "td-center">Telefone</td>
			<th class = "td-center">Responsavel</td>
...
?>		
	<tr>
		<td class = "td-center"><p><?= $dado['empresa'] ?></p></td>
		<td class = "td-center"><p><?= $dado['telefone']?></p></td>
		<td class = "td-center"><p><?= $dado['responsavel'] ?></p></td>
